      ...
      <div className={styles.sliderContainer}>
        ...
        >
          {isLoading ? (
            ...
            histograms.data.data.length > 0 ? histograms.data.data[0].data.map((item, index) => [
            ...
            ]) : <SwiperSlide className={styles.resultSwiperSlide}>
              <div className={styles.data}>
                <span className={styles.dataResults}>Пусто</span>
                <span className={styles.dataResults}>Пусто</span>
                <span className={styles.dataResults}>Пусто</span>
              </div>
            </SwiperSlide>
